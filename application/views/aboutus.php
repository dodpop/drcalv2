...
<!-- bradcam_area_start  -->
<div class="bradcam_area breadcam_about_bg_2 bradcam_overlay">
   <div class="container">
      <div class="row">
         <div class="col-xl-12">
...
<div class="welcome_docmed_area pb-0">
	<div class="container">
        <div class="row">
			<div class="col-xl-8 col-lg-8">
                <div class="welcome_docmed_info pl-0">
		...
		<div class="row">
			<div class="col-xl-8 col-lg-8">
				<div class="welcome_docmed_info pl-0">
					...
					<blockquote class="generic-blockquote">บริษัท ดอกเตอร์ คาลิเบรชั่น จำกัด ได้เปิดให้บริการสอบเทียบในประเทศไทยเมื่อปี พ.ศ. 2550 ภายใต้ชื่อบริษัท ไปเปต ดอกเตอร์ (ประเทศไทย) จำกัด โดยได้รับการรับรองมาตรฐานห้องปฎิบัติการสอบเทียบ ISO/IEC 17025 ของเครื่องมือไมโครไปเปต ขอบข่ายที่ได้รับการรับรอง 0.1 ul. - 10 ml. ห้องปฎิบัติการเป็นห้องที่สมบูรณ์แบบ ทั้งเครื่องมือ อุปกรณ์ที่ทันสมัย ตลอดจนบุคลกรที่มีคุณภาพ มีความรู้และประสบการณ์ พร้อมให้บริการสอบเทียบอย่างเต็มประสิทธิภาพ และบริการหลังการสอบเทียบ รวมทั้งการการันตีคุณภาพงานสอบสอบเทียบ ซึ่งในปัจจุบันเปิดให้บริการสอบเทียบ อาทิ Micropipette, Chamber, Bath, pH Meter และ Spectrophotometer และ ในปี 2556 ได้เปลี่ยนชื่อบริษัท เป็น บริษัท ดอกเตอร์ คาลิเบรชั่น จำกัด

					<br><br>
					</blockquote>		
								
                    <!-- <a href="/aboutus" class="boxed-btn3-white-2">Learn More</a>  -->
                </div>
            </div>
            <div class="col-xl-4 col-lg-4">
				<div class="welcome_thumb">
					<div > <img src="/public/img/company_building2.png" alt="" class="img-fluid"> </div>
